      ...
      <div className="w-full max-w-md rounded-2xl bg-facamWhite p-6 shadow-xl">
        <div className="mb-5 flex items-center justify-between">
          <h3 className="text-base font-semibold text-facamDark">
            {task ? "Modifier la tâche" : "Nouvelle tâche personnelle"}
          </h3>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="personal-task-title" className="text-sm font-medium text-facamBlack">
              Titre de la tâche
            </label>
            <input
              ...
              placeholder="Ex : Préparer mon entretien annuel"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="personal-task-description" className="text-sm font-medium text-facamBlack">
